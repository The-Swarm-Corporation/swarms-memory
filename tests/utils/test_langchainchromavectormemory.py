...
from swarms_memory import LangchainChromaVectorMemory
...
@pytest.fixture()
def embeddings_mock():
    with patch("swarms_memory.OpenAIEmbeddings") as mock:
        yield mock


@pytest.fixture()
def chroma_mock():
    with patch("swarms_memory.Chroma") as mock:
        yield mock


@pytest.fixture()
def qa_mock():
    with patch("swarms_memory.RetrievalQA") as mock:
        yield mock
